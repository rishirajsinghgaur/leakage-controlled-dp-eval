...
the chance result are stable at higher N. Output -> results/lira_n64_skab.json.
"""
...
R_REF = 64; PASSES = 12; SEEDS = 3; ds = "skab"; eps = 2.0
cfg = DS_CFG[ds]
...
for split in ["contiguous","randomized"]:
    ...
    (ROOT/"results"/"lira_n64_skab.json").write_text(json.dumps(out,indent=2))
print("DONE:", out)
